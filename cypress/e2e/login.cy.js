describe('Проверка авторизации', function () {
    ...
    it('Верный логин и верный пароль', function () {
        ...
        cy.wait(5000);
         ...
         cy.get('#messageHeader').should('be.visible');// текст не просто существует, а виден пользователям
         cy.get('#exitMessageButton > .exitIcon').should('be.visible');// проверка, что есть крестик и он виден пользователю
